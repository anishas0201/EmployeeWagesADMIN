    ...
    var e = "div", t = "button", a = "span", r = "p",
        ...
        o = {
            ...
            catagories: [
                ...
                { name: "Successfully Paid", value: 66, color: "#03c2fc" },

                { name: "Pending", value: 24, color: "#ff9f40" },

                { name: "Unpaid", value: 10, color: "#36a2eb" },
    ...
    window.addEventListener("load",
        ...
        function () {
            ...
            [].forEach.call(document.querySelectorAll("[data-stepped-bar]"),
                ...
                function (s, i) {
                    ...
                    if (s) {
                        ...
                        }); var m = c(e, ""); m.appendChild(p), m.appendChild(u), m.appendChild(v); var f = c(e, ""); f.appendChild(m); var y = c(e); y.appendChild(f), s.innerHTML = y.innerHTML, [].forEach.call(s.querySelectorAll(".syncro-progress-stepped-item"),
            ...
            progressBarItems.forEach((item, index) => {
                ...
                item.style.marginRight = ""; /* Adjust the margin as needed to create space between items */
            ...
            // Adding the text "(100 Employees)" after payment status

            const paymentStatus = document.querySelector(".syncro-card-title");

            paymentStatus.innerHTML += "<br><p> 100 <span>Employees </span> </p>";

 

            // const emps = document.querySelector(".syncro-card-title1");

            // emps.innerHTML += "<br>200 Employees";

            // emps.style.fontSize = "25px";
