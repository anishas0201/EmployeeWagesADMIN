...
function dom_isEmpty(node) {
  ...
  if (len === 0) {
    ...
    // ex) <p id="fot_font_size"><br></p>, <span><br></span>
    return true;
  } else if (lists.all(node.childNodes, isText) && node.innerHTML === '') {
    // ex) <p id="fot_font_size"></p>, <span></span>
    return true;
  }
...
function splitTree(root, point, options) {
  // ex) [#text, <span>, <p id="fot_font_size">]
...
/* harmony default export */ var dom = ({
  ...
  emptyPara: "<p id="fot_font_size">".concat(blankHTML, "</p>"),
...
var range_WrappedRange = /*#__PURE__*/function () {
  ...
  range_createClass(WrappedRange, [{
    ...
    value: function wrapBodyInlineWithPara() {
       ...
       *  - firefox: |<p id="fot_font_size">text</p>|
       *  - chrome: <p id="fot_font_size">|text|</p>
       */
    ...
    */
    ...
    value: function createTable(colCount, rowCount, options) {
      ...
      for (var idxCol = 0; idxCol < colCount; idxCol++) {
        tds.push(' <td id="fot_font_size1">' + dom.blank + '</td>');
      }
